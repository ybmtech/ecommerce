...
<body>
            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <h2 class="pageheader-title">Business Location</h2>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $rows=$dbquery->multiple_row_without_parameter('location','name','ASC');
                                            if($rows!==false){
                                                foreach($rows as $row):
                                            ?>
                                            <tr>
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                             <a class="dropdown-item edit-location" href="#" type="button" id="<?php echo $row['unique_id']; ?>" data-name="<?=$row['name'];?>"> Edit</a>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <form  id="delete_location_form">
                        ...
                        <input type="hidden" name="tbl" id="tbl" value="location">
                        <input type="hidden" name="token" id="token" value="<?= $_SESSION['_token']; ?>">
    ...
    <?php require_once __DIR__ . "/ajax/location.php"; ?>
    <script>
