        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              ...
              <li class="li"><a href="javascript:void(0)" class="btn btn-common btn-theme cursor-default">Account Dashboard</a></li>
          ...
          <div class="row">
            <div class="col-12">
              <div class="innerWrapper">
                ...
                <h3>Wellcome <span><?=strtoupper($_SESSION['name'])?></span></h3>
                      ...
                      <tbody>
                        <?php
                         $currencies=$dbquery->multiple_row_without_parameter('currencies','name','ASC');
                           $get_recent_orders=$dbquery->multiple_row_parameter_limit('orders','user_id',$_SESSION['customer_id'],'id','DESC',5);
                           if($get_recent_orders!==false)
                           foreach($get_recent_orders as $order){
